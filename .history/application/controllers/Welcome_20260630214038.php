...
class Welcome extends CI_Controller {
	...
	public function Dashboard(){
		...
		// Cards
		$result['dailySalesTotal']   = $this->Dashboardinfo->DailySalesTotal();
		$result['monthlySalesTotal'] = $this->Dashboardinfo->MonthlySalesTotal();
		$result['productsCount']     = $this->Dashboardinfo->ProductsCount();
		$result['ordersToday']       = $this->Dashboardinfo->OrdersTodayCount();

		// Charts
		$result['dailySalesChart']   = $this->Dashboardinfo->DailySalesChart(7);
		$result['monthlySalesChart'] = $this->Dashboardinfo->MonthlySalesChart(12);

		// Stock / movement
		$result['lowStockItems']  = $this->Dashboardinfo->LowStockItems();
		$result['fastMoving']     = $this->Dashboardinfo->FastMovingItems(5, 30);
		$result['slowMoving']     = $this->Dashboardinfo->SlowMovingItems(5, 30);
