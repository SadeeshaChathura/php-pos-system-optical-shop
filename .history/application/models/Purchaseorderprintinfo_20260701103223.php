        ...
        <head>
            ...
            <style>
                ...
                * { margin:0; padding:0; box-sizing:border-box; font-family: "Helvetica", Arial, sans-serif; }
                ...
                .info-panel { width:178mm; border:1px solid #dde3ee; border-radius:10px; margin-bottom:20px; border-collapse:collapse; overflow:hidden; }
                .info-panel td { vertical-align:top; padding:16px 20px; }
                ...
                /* ---------------- FOOTER ----------------
                   ...
                   to the bottom of every physical page. That's a well-known
                   dompdf trick, but it renders unreliably on single-page
                   documents (it simply didn't show up in testing). This
