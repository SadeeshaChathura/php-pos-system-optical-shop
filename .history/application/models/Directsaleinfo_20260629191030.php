...
public function Directsaleinsertupdate(){
    ...
    /*
     * tbl_invoice_payment / tbl_invoice_payment_detail are now used
     * ONLY for credit sales (billtype == 3), to track advance paid
     * and outstanding balance. Cash/Card payment info lives directly
     * on tbl_invoice (paymentgiven / changegiven) above.
     */
    if ($billtype == 3 && !empty($tableDataPay) && is_array($tableDataPay) && count($tableDataPay) > 0) {
