    ...
    <div class="inv-header">
        ...
        <div class="inv-meta">
            ...
            <table class="inv-meta-table" align="right">
                <tr><td class="lbl" align="right">Invoice No.</td><td class="val">' . $d['invoice_no'] . '</td></tr>
                <tr><td class="lbl align="right"">Date</td><td class="val">' . $d['invdate'] . '</td></tr>
                <tr><td class="lbl align="right"">Cashier</td><td class="val">' . htmlspecialchars($d['cashier']) . '</td></tr>
            </table>
