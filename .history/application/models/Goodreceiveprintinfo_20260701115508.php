        ...
        <head>
            ...
            <style>
                ...
                * { margin:0; padding:0; box-sizing:border-box; font-family: "Helvetica", Arial, sans-serif; }
                ...
                .supplier-panel { width:200mm; border:1px solid #dde3ee; border-radius:10px; margin-bottom:20px; padding:16px 20px; table-layout:fixed; border-collapse:collapse; }
