...
class Purchaseorderprintinfo extends CI_Model{
   ...
   private function _renderPorderShell($d){
    ...
    <head>
        ...
        <style>
            ...
            * { margin:0; padding:0; box-sizing:border-box; font-family: "Helvetica", Arial, sans-serif; }
            ...
            .page { width:210mm; padding:10mm 16mm 4mm 16mm; page-break-after: always; }
            ...
            .pcode { color:#8091a8; font-size:9.5px; font-family:monospace; }
            .pcomment { color:#8a7a13; font-size:9.5px; font-style:italic; margin-top:2px; }
            ...
            .footer-text-cell { font-size:9px; color:#dbe4f5; line-height:2; padding-left:12px; }
            .footer-thanks { font-size:9.5px; font-weight:700; color:#fff; text-align:left; padding-left:2px; }

            .page-number { text-align:center; font-size:9px; color:#6b7d85; margin-top:4px; }
    ...
    foreach ($pages as $pageNum => $pageItems) {
        ...
        // Show totals and remark only on last page
