        ...
        <head>
            ...
            <style>
                ...
                * { margin:0; padding:0; box-sizing:border-box; font-family: "Helvetica", Arial, sans-serif; }
                ...
                .page { width:210mm; padding:10mm 16mm 64mm 16mm; }
                ...
                /* ---------------- INFO CARDS ---------------- */
                .info-strip-table { width:178mm; border-collapse:separate; border-spacing:0; margin-bottom:20px; }
                .info-box { width:86mm; background:#F3F6FB; border-left:4px solid #254F96; border-radius:8px; padding:16px 18px; vertical-align:middle; text-align:center; }
                .info-spacer { width:6mm; }
                .info-box .lbl { font-size:9px; text-transform:uppercase; letter-spacing:.8px; color:#254F96; font-weight:800; margin-bottom:7px; }
                .info-box .val { font-size:13px; font-weight:700; color:#1c2b33; margin-bottom:4px; }
                ...
                /* ---------------- FIXED FOOTER ----------------
                   Positioned relative to the page so it repeats pinned
                   to the bottom of every page. .page padding-bottom
                   above reserves space so content never overlaps it. */
                .page-footer { position:fixed; bottom:0; left:0; width:210mm; }
                .footer-accent { width:210mm; height:4px; background:#254F96; margin-bottom:10mm; }
                .footer-inner { padding:0 16mm 10mm 16mm; }
                ...
                .footer-contact { width:178mm; background:#254F96; border-radius:8px; padding:10px 16px; border-collapse:collapse; }
