...
class Directsalecreditreceiptinfo extends CI_Model {
    ...
    public function Getcreditprintbill($x){
        ...
        // Build item rows for the A4 table (same visual structure as the cash/card invoice)
        $tblinvoice = '';
        $rowIdx = 1;
        ...
        $extraTotalsHtml = '
            <div class="paid-row"><span>Advance Paid</span><span>Rs. ' . number_format($totalpay, 2) . '</span></div>
            <div class="due-row"><span>Balance Due</span><span>Rs. ' . number_format($balancedue, 2) . '</span></div>
        ';

        $noticeHtml = '
            <div class="credit-notice">
                &#9888; <span><b>Important:</b> This is a credit sale. Please settle the outstanding balance of <b>Rs. ' . number_format($balancedue, 2) . '</b> within the agreed credit period.</span>
            </div>
        ';
        ...
        $html = $this->_renderInvoiceShell(array(
            'doc_title'        => 'CREDIT INVOICE',
            'invoice_no'       => 'INV-' . str_pad($invid, 6, '0', STR_PAD_LEFT),
            'invdate'          => date('d M Y, h:i A', strtotime($invdate)),
            'cashier'          => $cashier,
            'status_pill_cls'  => 'credit',
            'status_pill_text' => '&#8987; CREDIT &mdash; BALANCE DUE',
            'cust_name'        => $name ? $name : 'Customer',
            'cust_meta'        => $custMeta,
            'sale_type_label'  => 'Credit Sale',
            'sale_type_sub'    => 'Settle within agreed credit period',
            'itemcount'        => $itemcount,
            'sumqty'           => $sumqty,
            ...
            'footer_thanks'    => 'Thank you for choosing &#3637;&#3576;&#3653;&#3654;&#3517;&#3719; Optical!',
            'footer_sub'       => 'Please retain this invoice and settle your balance before the due date.',
        ));
    ...
    /**
     * Shared A4 invoice shell — identical markup/styles to Directsalereceiptinfo's shell,
     * kept duplicated here (rather than shared via a helper/library) so this model has
     * no dependency on the other and can be dompdf-rendered standalone.
     */
...
<head>
    ...
    <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; font-family: "Helvetica", Arial, sans-serif; }
        ...
        .brand-contact { font-size:10px; color:#475a61; margin-top:6px; line-height:1.5; }
        .brand-contact b { color:#0d7890; }
        ...
        .footer-note { font-size:10.5px; color:#6b7d85; text-align:center; border-top:1px solid #dde6e9; padding-top:14px; margin-top:24px; }
        .footer-note .thanks { font-size:14px; font-weight:800; color:#0d7890; margin-bottom:4px; }
        .terms { font-size:9px; color:#9aa7ac; margin-top:8px; line-height:1.5; }
        .footer-bottom { margin-top:14px; text-align:center; font-size:8.5px; color:#aab5b9; }
    </style>
</head>
<body>
<div class="page">
    ...
    <div class="inv-header">
        <div class="brand-block">
            ...
            <div>
                <div class="brand-name">&#3637;&#3576;&#3653;&#3654;&#3517;&#3719; PVT LTD</div>
                <div class="brand-sub">Optical Care &amp; Eyewear Specialists</div>
                <div class="brand-contact">
                    <b>Address:</b> Kannadiya Pvt Ltd, Thalawa Road, Kekirawa<br>
                    <b>Tel:</b> 0719622717 / 0703955682 &nbsp;|&nbsp; <b>Email:</b> Kannadiyaopticalservice@gmail.com
                </div>
            </div>
        </div>
        <div class="inv-meta">
    ...
    <div class="footer-note">
        <div class="thanks">' . $d['footer_thanks'] . '</div>
        ' . $d['footer_sub'] . '
        <div class="terms">
            Frames carry a 6-month manufacturing warranty. Lenses are non-returnable once dispensed.<br>
            Outstanding balances may be settled at our counter or via bank transfer. This is a computer-generated invoice and does not require a signature.
        </div>
    </div>

    <div class="footer-bottom">
        &#3637;&#3576;&#3653;&#3654;&#3517;&#3719; Pvt Ltd &middot; Thalawa Road, Kekirawa &middot; 0719622717 / 0703955682 &middot; Kannadiyaopticalservice@gmail.com
    </div>
</div>
</body>
</html>';
