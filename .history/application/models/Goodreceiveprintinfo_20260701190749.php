        ...
        <head>
            ...
            <style>
                ...
                * { margin:0; padding:0; box-sizing:border-box; font-family: "Helvetica", Arial, sans-serif; }
                ...
                .footer-contact { width:178mm; background:#254F96; border-radius:8px; padding:14px 0; border-collapse:collapse; margin-bottom:6px; }
                ...
                .footer-text-cell { font-size:9px; color:#dbe4f5; line-height:1.7; padding-left:28px; }
                .footer-thanks { font-size:9.5px; font-weight:700; color:#fff; text-align:right; padding-right:251px; }
