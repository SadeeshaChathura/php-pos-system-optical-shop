...
class Invoiceviewinfo extends CI_Model{
    ...
    public function Getinvoicedetails(){
        ...
        $sql = "SELECT `tbl_invoice_detail`.`idtbl_invoice_detail`, `tbl_invoice_detail`.`qty`, `tbl_invoice_detail`.`total`,`tbl_material_info`.`productcode`
    ...
    public function GetProductsByInvoiceID($invoice_id) {
        $this->db->select('p.idtbl_material_info, p.materialname');
        $this->db->from('tbl_invoice_detail as id');
        $this->db->join('tbl_material_info as p', 'id.tbl_material_info_idtbl_material_info = p.idtbl_material_info');
    ...
    public function GetBatchesByProductAndLocation($product_id, $location_id) {
        $this->db->select('idtbl_material_info_stock, fgbatchno, insertdatetime');
        $this->db->from('tbl_material_info_stock');
        $this->db->where('tbl_material_info_idtbl_material_info', $product_id);
