...
class Purchaseorderprintinfo extends CI_Model{
   ...
   private function _renderPorderShell($d){
    ...
    // Point this to your actual logo file (e.g. base_url() . 'assets/images/logo.png')
    $bizLogo  = base_url() . 'assets/images/logo.png';
        ...
        <head>
            ...
            <style>
                ...
                * { margin:0; padding:0; box-sizing:border-box; font-family: "Helvetica", Arial, sans-serif; }
                ...
                .info-box { width:87mm; background:#f7fafb; border:1px solid #dde6e9; border-radius:10px; padding:12px 14px; vertical-align:top; }
                .info-spacer { width:4mm; }
        ...
        <div class="page">
            ...
            <table class="header-table">
                <tr>
                    <td class="header-left">
                        <img src="' . $bizLogo . '" class="logo-img" alt="logo">
            ...
            <div class="footer-area">
                ...
                <table class="footer-contact">
                    <tr>
                        <td class="footer-logo-cell"><img src="' . $bizLogo . '" alt="logo"></td>
