...
class Goodreceiveprintinfo extends CI_Model{
    ...
    public function Getgrnprintpdf($x){
        ...
        // _renderGrnShell), same pattern used for the credit invoice
        // and the Purchase Order print.
        echo $html;
    }
   ...
   private function _renderGrnShell($d){
    ...
    // path dompdf required. Same logo file as the Purchase Order print.
    ...
    return '
        ...
        <head>
            ...
            <style>
                ...
                * { margin:0; padding:0; box-sizing:border-box; font-family: "Helvetica", Arial, sans-serif; }
                ...
                .supplier-panel { width:178mm; border:none; border-radius:10px; margin-bottom:20px; table-layout:fixed; border-collapse:collapse; }
                ...
                .footer-contact { width:178mm; background:#254F96; border-radius:8px; padding:16px 26px; border-collapse:collapse; margin-bottom:6px; }
                ...
                .footer-text-cell { font-size:9px; color:#dbe4f5; line-height:1.7; padding-left:20px; }
                .footer-thanks { font-size:9.5px; font-weight:700; color:#fff; text-align:right; padding-right:14px; }
        ...
        <script>
            // Same pattern used for the credit invoice and the Purchase
            // Order print: print automatically once the page (and logo
