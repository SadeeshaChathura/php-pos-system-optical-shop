...
/*
 * Insert payment records ONLY for Cash and Card sales.
 * Credit sales do not create payment records.
 */
if ($billtype == 1 || $billtype == 2) {
    ...
    if (!empty($tableDataPay) && is_array($tableDataPay)) {
        ...
        // If no payment rows were submitted, create one automatically.
        $paymentDetail = array(
            'method'                                    => ($billtype == 1) ? 'Cash' : 'Card',
            'amount'                                    => $paytotal,
            'bank'                                      => '',
            'branch'                                    => '',
            'chequeno'                                  => '',
