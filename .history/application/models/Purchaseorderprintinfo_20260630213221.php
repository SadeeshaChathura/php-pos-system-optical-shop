...
class Purchaseorderprintinfo extends CI_Model{
   ...
   private function _renderPorderShell($d){
    ...
    // Sinhala text is silently dropped. Place a Sinhala-capable TTF (e.g.
    // Noto Sans Sinhala, download free from Google Fonts) at the path below.
        ...
        <head>
            ...
            <style>
                ...
                * { margin:0; padding:0; box-sizing:border-box; font-family: "Helvetica", Arial, sans-serif; }
                ...
                .logo-img { max-height:42px; max-width:60mm; margin-bottom:6px; }
                ...
                .status-pill { display:inline-block; margin-top:10px; margin-bottom:4px; padding:4px 14px; border-radius:999px; font-size:10.5px; font-weight:700; background:#e7f8ee; color:#1f9d55; }
                ...
                .info-box { width:87mm; background:#f7fafb; border:1px solid #dde6e9; border-radius:10px; padding:14px 16px; vertical-align:top; }
                ...
                .footer-logo-cell img { max-height:34px; max-width:16mm; }
                ...
                .sign-table { width:178mm; margin-top:0; margin-bottom:24px; border-collapse:collapse; }
        ...
        <div class="page">
            ...
            <div class="footer-area">
                ...
                <table class="footer-contact">
                    <tr>
                        ' . ($bizLogoTag ? '<td class="footer-logo-cell">' . $bizLogoTag . '</td>' : '') . '
