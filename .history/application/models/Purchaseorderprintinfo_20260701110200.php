...
$bizLogoPath = base_url('assets/images/logo.png');

$headerBrandBlock = '<img src="' . $bizLogoPath . '" class="logo-img" alt="Kannadiya Optical Services">';

$footerBrandBlock = '<img src="' . $bizLogoPath . '" class="footer-logo-img" alt="logo">';
