        ...
        <main>
            ...
            <div class="container-fluid mt-4 ml-2">
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="panel-card">
                            <div class="panel-title"><i class="fas fa-calendar-alt text-success"></i> Monthly Sales (Last 12 Months)</div>
                            <div class="chart-container">
        ...
        <?php if (!empty($lowStockItems)): ?>
            <?php foreach ($lowStockItems as $item): ?>
                ...
                <div class="movement-row">
                    <div>
                        <strong><?php echo htmlspecialchars($item->materialname); ?></strong><br>
                        <small class="text-muted">
                            Current Stock:
                            <span class="text-danger font-weight-bold">
                                <?php echo (int)$item->currentstock; ?>
                            </span>
                            &nbsp;|&nbsp;
                            Reorder Level:
                            <span class="text-primary font-weight-bold">
                                <?php echo (int)$item->reorderlevel; ?>
                            </span>
                        </small>
                    </div>
                </div>
