                    ...
                    },
                    {
                        ...
                        "render": function(data, type, full) {
                            var button = '';
                                ...
                                button += '<a href="<?php echo base_url() ?>Invoiceview/printreportpos/' + full['idtbl_invoice'] + '" target="_blank" class="btn btn-primary btn-sm"><i class="fas fa-file-invoice"></i></a>';
