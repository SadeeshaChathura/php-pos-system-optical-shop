...
<html lang="en">
    <head>
        ...
        <title>Quantum Pay - By CalciteX</title>
        <link href="<?php echo base_url() ?>assets/css/styles.css" rel="stylesheet" />
        <link href="<?php echo base_url() ?>assets/css/pos-styles.css" rel="stylesheet" />
        <!-- Vendor CSS -->
<link href="<?php echo base_url() ?>assets/css/sb-admin-pro.min.css" rel="stylesheet">
<link href="<?php echo base_url() ?>assets/css/bootstrap-extras.css" rel="stylesheet">

<!-- Flatpickr (only needed on pages using the calendar, or load globally — your call) -->
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/flatpickr/dist/flatpickr.min.css">

<!-- Your custom overrides — always last -->
<link href="<?php echo base_url() ?>assets/css/app-custom.css" rel="stylesheet">
        ...
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/Mottie-Keyboard/1.30.1/css/keyboard.min.css">
