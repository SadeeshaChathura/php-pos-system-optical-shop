...
<nav class="sidenav shadow-right sidenav-light">
    ...
    <div class="sidenav-brand">
        <img src="<?php echo base_url() ?>images/QP logo transparent.png" alt="Logo">
        <span class="sidenav-brand-text">QP Admin</span>
    </div>

    <div class="sidenav-menu">
        <div class="nav accordion" id="accordionSidenav">

            <a class="nav-link<?php if($functionmenu2=='Dashboard'){echo ' active';} ?>" href="<?php echo base_url().'Welcome/Dashboard'; ?>">
