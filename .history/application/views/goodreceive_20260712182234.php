...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#product').change(function () {
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    if (obj.costprice > 0) {
                        ...
                        $('#lastgrnpricehint')
                            .html('No previous GRN cost found')
            ...
            // ================= PO AJAX (qty & comment ALWAYS; price only as fallback) =================
            $.ajax({
                type: "POST",
                data: {
                    recordID: productID,
                ...
                success: function (result) {
                    ...
                    // Qty and comment must reflect the PO line regardless of GRN price lookup
                    $('#newqty').val(obj.qty);
                    $('#comment').val(obj.comment);

                    // Only fall back to the PO's unit price if there's no last-GRN price
                    if (!grnPrice) {
