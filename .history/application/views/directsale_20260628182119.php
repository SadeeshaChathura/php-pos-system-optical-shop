                    ...
                    <div class="pos-right">
                        ...
                        <div class="pos-cart-summary">
                            ...
                            <div class="pos-pay-buttons">
                                <div class="pos-pay-buttons-row">
                                    <button class="pos-pay-btn cash w-100" id="btnPayCash" disabled><i class="fas fa-money-bill-wave"></i> Cash</button>
                                    <button class="pos-pay-btn card w-100" id="btnPayCard" disabled><i class="fas fa-credit-card"></i> Card</button>
                                </div>
