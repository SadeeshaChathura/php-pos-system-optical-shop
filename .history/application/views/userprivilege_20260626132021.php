            ...
            "columns": [
                ...
                },
                {
                    ...
                    "render": function(data, type, full) {
                        ...
                        if(full['status']==1){
                        button+='<a href="<?php echo base_url() ?>User/Userprivilegestatus/'+full['idtbl_user_privilege']+'/2" onclick="return deactive_confirm()" target="_self" class="btn btn-success btn-sm mr-1 ';if(statuscheck==0){button+='d-none';}button+='"><i class="fas fa-check-sq"></i></a>';
                        }else {
