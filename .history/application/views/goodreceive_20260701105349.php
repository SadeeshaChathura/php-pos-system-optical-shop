            ...
            "columns": [
                ...
                },
                {
                    ...
                    "render": function(data, type, full) {
                        ...
                        button+='<a href="<?php echo base_url() ?>Goodreceive/Getgrnprintpdf/'+full['idtbl_grn']+'" target="_blank" class="btn btn-info btn-sm mr-1" data-toggle="tooltip" data-placement="bottom" title="Print GRN"><i class="fas fa-print"></i></a>';
