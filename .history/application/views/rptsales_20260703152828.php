...
function buildTable(mode) {
    ...
    salesTable = $('#salesTable').DataTable({
        ...
        buttons: [
            { extend: 'csv', className: 'btn btn-success btn-sm', filename: 'Sales Report ' + today, text: '<i class="fas fa-file-csv mr-2"></i> CSV' },
            { extend: 'excel', className: 'btn btn-info btn-sm', filename: 'Sales Report ' + today, text: '<i class="fas fa-file-excel mr-2"></i> EXCEL' },
            { extend: 'pdf', className: 'btn btn-danger btn-sm', filename: 'Sales Report ' + today, text: '<i class="fas fa-file-pdf mr-2"></i> PDF', orientation: 'landscape' },
            { extend: 'print', className: 'btn btn-primary btn-sm', text: '<i class="fas fa-print mr-2"></i> PRINT' }
        ]
    });
}
