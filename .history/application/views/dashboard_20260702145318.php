...
.calendar-selected-note strong { color:#0d7890; }
.today-link {
    font-size: .78rem;
    font-weight: 700;
    color: #0d7890;
...
.today-link:hover { text-decoration: underline; color:#0d7890; }

/* Inline flatpickr, teal themed */
...
.flatpickr-weekdays { background: #0d7890; border-radius: 8px 8px 0 0; }
.flatpickr-current-month input.cur-year,
.flatpickr-current-month .flatpickr-monthDropdown-months { color:#fff; }
.flatpickr-current-month .flatpickr-monthDropdown-months option { color:#222; }
