...
<div class="modal fade" id="porderviewmodal" data-backdrop="static" data-keyboard="false" tabindex="-1"
	...
	<div class="modal-dialog modal-dialog-centered modal-lg">
		<div class="modal-content">
			<div class="modal-header">
            <h4 class="text-left">CALX/POD-<label id="procode"></label></h4>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
            ...
            "columns": [
                ...
                },
                {
                    ...
                    "render": function(data, type, full) {
                        ...
                        button+='<button class="btn btn-info btn-sm btnprintpo mr-1" data-toggle="tooltip" data-placement="bottom" title="Print PDF" data-id="'+full['idtbl_porder']+'"><i class="fas fa-file-pdf"></i></button>';
                        if(full['confirmstatus']==1){
                            ...
                            button+='<a href="<?php echo base_url() ?>Purchaseorder/Purchaseorderstatus/'+full['idtbl_porder']+'/1" onclick="return active_confirm()" target="_self" data-toggle="tooltip" data-placement="bottom" title="Approve Purchase Order" class="btn btn-danger btn-sm mr-1 ';if(statuscheck!=1){button+='d-none';}button+='"><i class="fas fa-times-circle"></i></a>';
                        }
