                ...
                <div class="modal-body">
                        ...
                        <table class="table table-bordered text-center mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><input type="text" class="form-control form-control-sm" name="distance_r_sph"></td>
                                    <td><input type="text" class="form-control form-control-sm" name="distance_r_cyl"></td>
                                    <td><input type="text" class="form-control form-control-sm" name="distance_r_axis"></td>
                                    <td><input type="text" class="form-control form-control-sm" name="distance_l_sph"></td>
                                    <td><input type="text" class="form-control form-control-sm" name="distance_l_cyl"></td>
                                    <td><input type="text" class="form-control form-control-sm" name="distance_l_axis"></td>
                                </tr>
                                <tr>
                                    <th class="align-middle">Read ADD</th>
                                    <td><input type="text" class="form-control form-control-sm" name="readadd_r_sph"></td>
                                    <td><input type="text" class="form-control form-control-sm" name="readadd_r_cyl"></td>
                                    <td><input type="text" class="form-control form-control-sm" name="readadd_r_axis"></td>
                                    <td><input type="text" class="form-control form-control-sm" name="readadd_l_sph"></td>
                                    <td><input type="text" class="form-control form-control-sm" name="readadd_l_cyl"></td>
                                    <td><input type="text" class="form-control form-control-sm" name="readadd_l_axis"></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-row">
                                <div class="col-auto form-check">
                                    <input class="form-check-input" type="radio" name="lens_vision" id="lv_sv" value="S/V">
                                    <label class="form-check-label" for="lv_sv">S/V</label>
                                </div>
                                <div class="col-auto form-check">
                                    <input class="form-check-input" type="radio" name="lens_vision" id="lv_bf" value="Bi Focal">
                                    <label class="form-check-label" for="lv_bf">Bi Focal</label>
                                </div>
                                <div class="col-auto form-check">
                                    <input class="form-check-input" type="radio" name="lens_vision" id="lv_pg" value="Progressive">
                                    <label class="form-check-label" for="lv_pg">Progressive</label>
                                </div>
                            </div>
                        </div>
                        <!-- Lens material -->
                        <div class="col-md-6">
                            ...
                            <div class="form-row">
                                <div class="col-auto form-check">
                                    <input class="form-check-input" type="radio" name="lens_material" id="lm_cr39" value="CR-39">
                                    <label class="form-check-label" for="lm_cr39">CR-39</label>
                                </div>
                                <div class="col-auto form-check">
                                    <input class="form-check-input" type="radio" name="lens_material" id="lm_glass" value="Glass">
                                    <label class="form-check-label" for="lm_glass">Glass</label>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                            <label>Length of Temple to Bend</label>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-9">
                            <label class="d-block">Coating</label>
                            <div class="form-row">
                                <div class="col-auto form-check">
                                    <input class="form-check-input" type="checkbox" name="coat_a2" id="coat_a2" value="1">
                                    <label class="form-check-label" for="coat_a2">A-2</label>
                                </div>
                                <div class="col-auto form-check">
                                    <input class="form-check-input" type="checkbox" name="coat_sp20" id="coat_sp20" value="1">
                                    <label class="form-check-label" for="coat_sp20">SP-20</label>
                                </div>
                                <div class="col-auto form-check">
                                    <input class="form-check-input" type="checkbox" name="coat_hmc" id="coat_hmc" value="1">
                                    <label class="form-check-label" for="coat_hmc">H.M.C</label>
                                </div>
                                <div class="col-auto form-check">
                                    <input class="form-check-input" type="checkbox" name="coat_pgx" id="coat_pgx" value="1">
                                    <label class="form-check-label" for="coat_pgx">P.G.X</label>
                                </div>
                                <div class="col-auto form-check">
                                    <input class="form-check-input" type="checkbox" name="coat_pbx" id="coat_pbx" value="1">
                                    <label class="form-check-label" for="coat_pbx">P.B.X</label>
                                </div>
                                <div class="col-auto form-check">
                                    <input class="form-check-input" type="checkbox" name="coat_bluecut" id="coat_bluecut" value="1">
                                    <label class="form-check-label" for="coat_bluecut">Blue Cut</label>
                                </div>
                            </div>
                        </div>
                    </div>
