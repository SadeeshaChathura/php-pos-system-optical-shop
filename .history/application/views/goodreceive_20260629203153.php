        ...
        $('#product').change(function(){
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    // ONLY set PO price if GRN is empty OR user preference
                    if(!$('#unitprice').data('grn-set')) {
                        $('#newqty').val(obj.qty);
