                ...
                },
                {
                    ...
                    "render": function(data, type, full) {
                        ...
                        if(full['status']==1){
                            ...
                            button+='<a href="<?php echo base_url() ?>User/Useraccountstatus/'+full['idtbl_user']+'/1" onclick="return active_confirm()" target="_self" class="btn btn-warning btn-sm mr-1 ';if(statuscheck!=1){button+='d-none';}button+='"><i class="fas fa-times-circl"></i></a>';
                        }
