...
function buildTable() {
    grnTable = $('#grnTable').DataTable({
        ...
        buttons: [
            ...
            { extend: 'excel', className: 'btn btn-ocean-blue btn-sm', filename: 'GRN Report ' + today, text: '<i class="fas fa-file-excel mr-2"></i> EXCEL' },
            { extend: 'pdf', className: 'btn btn-ocean-blue btn-sm', filename: 'GRN Report ' + today, text: '<i class="fas fa-file-pdf mr-2"></i> PDF', orientation: 'landscape' },
