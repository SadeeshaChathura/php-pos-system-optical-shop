...
$joinQuery = "FROM `tbl_material_info` AS `u` LEFT JOIN `tbl_material_category` AS `ua` ON (`ua`.`idtbl_res_material_category` = `u`.`tbl_res_material_category_idtbl_res_material_category`)";
