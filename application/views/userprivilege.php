            ...
            <div class="container-fluid mt-2 p-0 p-2">
                <div class="row erp-stack-row">
                    ...
                    <div class="erp-panel-form">
                        <div class="card">
                            <div class="card-header">User Privilege Details</div>
                            <div class="card-body">
                                <form action="<?php echo base_url() ?>User/Userprivilegeinsertupdate" method="post" autocomplete="off">
                                    ...
                                    <div class="erp-form-grid">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-control-sm" name="userlist" id="userlist" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-control-sm" name="menulist[]" id="menulist" required multiple>
                    ...
                    <div class="erp-panel-table">
                        <div class="card">
                            <div class="card-header">User Privilege List</div>
...
<script>
    $(document).ready(function() {
        ...
        $('#dataTable').DataTable( {
            ...
            buttons: [
                { extend: 'csv', className: 'btn btn-ocean-blue btn-sm', title: 'User Access Information', text: '<i class="fas fa-file-csv mr-2"></i> CSV' },
                { extend: 'pdf', className: 'btn btn-ocean-blue btn-sm', title: 'User Access Information', text: '<i class="fas fa-file-pdf mr-2"></i> PDF' },
                { 
                    extend: 'print', 
            ...
            "columns": [
                ...
                },
                {
                    ...
                    "render": function(data, type, full) {
                        var button='';
                        button+='<button class="btn btn-primary btn-sm btnEdit mr-1 ';if(editcheck==0){button+='d-none';}button+='" id="'+full['idtbl_user_privilege']+'" data-toggle="tooltip" title="Edit"><i class="fas fa-edit"></i></button>';
                        if(full['status']==1){
                        button+='<a href="<?php echo base_url() ?>User/Userprivilegestatus/'+full['idtbl_user_privilege']+'/2" onclick="return deactive_confirm()" target="_self" class="btn btn-success btn-sm mr-1 ';if(statuscheck==0){button+='d-none';}button+='" data-toggle="tooltip" title="Deactivate"><i class="fas fa-check-square"></i></a>';
                        }else {
                        button+='<a href="<?php echo base_url() ?>User/Userprivilegestatus/'+full['idtbl_user_privilege']+'/1" onclick="return active_confirm()" target="_self" class="btn btn-warning btn-sm mr-1 ';if(statuscheck==0){button+='d-none';}button+='" data-toggle="tooltip" title="Activate"><i class="fas fa-times-circle"></i></a>';
                        }
                        button+='<a href="<?php echo base_url() ?>User/Userprivilegestatus/'+full['idtbl_user_privilege']+'/3" onclick="return delete_confirm()" target="_self" class="btn btn-danger btn-sm ';if(deletecheck==0){button+='d-none';}button+='" data-toggle="tooltip" title="Delete"><i class="far fa-trash-alt"></i></a>';
    ...
    function resetForm() {
        ...
        $('#recordOption').val('1');
        $('#userlist').val('');
        $('#menulist').val(null).trigger('change');
