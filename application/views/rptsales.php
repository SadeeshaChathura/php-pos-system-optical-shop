...
function buildTable(mode) {
    ...
    salesTable = $('#salesTable').DataTable({
        ...
        buttons: [
            { extend: 'csv',  title: 'Kannadiya Pvt Ltd', className: 'btn btn-ocean-blue btn-sm', filename: 'Sales Report ' + today, text: '<i class="fas fa-file-csv mr-2"></i> CSV' },
            { extend: 'excel',  title: 'Kannadiya Pvt Ltd', className: 'btn btn-ocean-blue btn-sm', filename: 'Sales Report ' + today, text: '<i class="fas fa-file-excel mr-2"></i> EXCEL' },
            { extend: 'pdf',  title: 'Kannadiya Pvt Ltd', className: 'btn btn-ocean-blue btn-sm', filename: 'Sales Report ' + today, text: '<i class="fas fa-file-pdf mr-2"></i> PDF'},
            { extend: 'print',  title: 'Kannadiya Pvt Ltd', className: 'btn btn-ocean-blue btn-sm', text: '<i class="fas fa-print mr-2"></i> PRINT' }
        ]
    });
}
