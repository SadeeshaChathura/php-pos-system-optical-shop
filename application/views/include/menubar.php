...
else if($functionmenu=='CustomerPrescription'){
...
<nav class="sidenav shadow-right sidenav-light">
    ...
    <div class="sidenav-menu">
        <div class="nav accordion" id="accordionSidenav">
            ...
            <?php if(menucheck($menuprivilegearray, 5)==1 | menucheck($menuprivilegearray, 18)==1){ ?>
            <div class="sidenav-item" data-flyout-title="Customers">
                <a class="nav-link collapsed" data-title="Customers" href="javascript:void(0);" data-toggle="collapse" data-target="#collapseCustomers" aria-expanded="false" aria-controls="collapseCustomers">
