...
<script>
    $(document).ready(function() {
        ...
        $('#dataTable').DataTable({
            ...
            buttons: [
                { extend: 'csv', className: 'btn btn-ocean-blue btn-sm', title: 'User Type Information', text: '<i class="fas fa-file-csv mr-2"></i> CSV' },
                { extend: 'pdf', className: 'btn btn-ocean-blue btn-sm', title: 'User Type Information', text: '<i class="fas fa-file-pdf mr-2"></i> PDF' },
                { 
                    extend: 'print', 
                    title: 'User Type Information',
