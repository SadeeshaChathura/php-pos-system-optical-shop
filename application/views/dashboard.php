...
@media (max-width: 767.98px) {
    .chart-container, .chart-container-sm { height: 240px; }
    .stat-value { font-size: 1.3rem; }
    .stat-card, .panel-card, .calendar-card { padding: 1.1rem; }
    .page-header-content { flex-wrap: wrap; gap: .75rem; }
    .table-responsive table { font-size: .82rem; }
    .welcome-company-badge { width: 100%; justify-content: center; }
}
</style>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="stat-card d-flex flex-column justify-content-between">
                                    ...
                                    <a href="<?php echo base_url() ?>Materialdetail" class="btn btn-products btn-block mt-3">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="stat-card d-flex flex-column justify-content-between">
                                    ...
                                    <a href="<?php echo base_url() ?>Directsale" class="btn btn-danger btn-block mt-3">
                            ...
                            <div class="table-responsive">
                                <table class="table table-sm mb-0">
                                    ...
                                    <?php foreach ($overdueOrders as $o):
                                        ...
                                        $daysLate = (int)((strtotime(date('Y-m-d')) - strtotime($o->duedate)) / 86400);
                                    ?>
                                        <tr class="reorder-alert">
                                            ...
                                            <td class="text-danger font-weight-bold"><?php echo date('M j, Y', strtotime($o->duedate)); ?> (<?php echo $daysLate; ?>d late)</td>
